...
- **Don't fragment a single fact into multiple edges.** If a sentence packs version, default, and additivity into one rich claim, that's ONE fact with context inline. Don't split into fragments.
